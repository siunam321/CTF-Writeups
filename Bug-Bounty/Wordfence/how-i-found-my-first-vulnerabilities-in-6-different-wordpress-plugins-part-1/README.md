...
- [Overview](#overview)  
- [Before Doing WordPress Plugin Bug Bounty](#before-doing-wordpress-plugin-bug-bounty)  
...
- [Authenticated (Administrator+) Arbitrary File Read And Deletion (CVE-2024-7777)](#authenticated-administrator-arbitrary-file-read-and-deletion-cve-2024-7777)  
    - [Arbitrary File Deletion](#arbitrary-file-deletion)  
        ...
        - [Arbitrary File Deletion via Method `deleteBlukForm`](#arbitrary-file-deletion-via-method-deleteblukform)  
