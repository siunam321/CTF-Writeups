...
| [CVE-2024-9669](https://www.cve.org/CVERecord?id=CVE-2024-9669) | [Filester]([Filester](https://wordpress.org/plugins/filester/)) | [Authenticated (Administrator+) Local JavaScript File Inclusion](https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/filester/file-manager-pro-filester-185-authenticated-administrator-local-javascript-file-inclusion) |
